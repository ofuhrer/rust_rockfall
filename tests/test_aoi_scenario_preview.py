...
class AoiScenarioPreviewTests(unittest.TestCase):
    def test_tiny_reviewed_fixture_is_ready_for_local_smoke(self) -> None:
        ...
        self.assertEqual(report["cardinality_pressure_summary"]["scenario_count"], 3)
        self.assertEqual(report["cardinality_pressure_summary"]["expected_trajectory_count"], 3)
        self.assertEqual(report["cardinality_pressure_summary"]["first_cardinality_growth_driver"], "block_family_count")
        self.assertIn("pre-execution estimate", report["cardinality_pressure_summary"]["claim_boundary"])
        self.assertEqual(report["rows"][0]["expected_trajectory_count"], 1)
    ...
    def test_multi_zone_fixture_aggregates_rows_and_supports_balfrin_postproc(self) -> None:
        ...
        self.assertEqual(report["cardinality_pressure_summary"]["expected_trajectory_count"], 36)
        self.assertEqual(report["cardinality_pressure_summary"]["first_cardinality_growth_driver"], "source_zone_count")
    ...
    def test_selected_zone_counts_generate_scratch_root_pressure_summary(self) -> None:
        ...
        self.assertEqual(report["selected_zone_count_reports"][-1]["expected_trajectory_count"], 216)
        self.assertEqual(report["cardinality_pressure_summary"]["scenario_count"], 36)
        self.assertEqual(report["cardinality_pressure_summary"]["expected_trajectory_count"], 216)
        self.assertEqual(report["cardinality_pressure_summary"]["first_cardinality_growth_driver"], "source_zone_count")
        self.assertTrue(
