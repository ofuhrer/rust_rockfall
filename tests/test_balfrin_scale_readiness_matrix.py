...
class BalfrinScaleReadinessMatrixTests(unittest.TestCase):
    def test_build_report_composes_the_authoritative_baseline_matrix(self) -> None:
        ...
        self.assertIn("TB-669 is the latest measured bounded hazard-throughput evidence", report["summary"])
        ...
        self.assertEqual(report["hazard_throughput_status"]["job_id"], "4378015")
        self.assertEqual(report["hazard_throughput_status"]["release_zone_count"], 12)
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "use_tb669_hazard_throughput_support_for_next_scale_projection",
        )
        self.assertEqual(report["hazard_throughput_status"]["runtime_seconds"], 0.288978714030236)
        self.assertEqual(report["hazard_throughput_status"]["memory_peak_mb"], 47.016)
        ...
        self.assertEqual(report["hazard_throughput_status"]["hazard_output_bytes"], 1148530)
        ...
        self.assertIn("TB-669 is latest bounded hazard-throughput support", tb652_row["comparison_anchor"])
        ...
        self.assertIn("TB-669 is latest bounded hazard-throughput support", tb665_row["comparison_anchor"])
