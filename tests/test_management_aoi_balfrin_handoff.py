...
class ManagementAoiBalfrinHandoffTests(unittest.TestCase):
    ...
    def _scenario_pressure_report(self) -> dict[str, object]:
        return {
            ...
            "candidate_evidence": {
                ...
                "review_summary": {"candidate_count": 0, "review_row_count": 0},
            },
            "scenario_generation_pressure": {
                "scenario_row_count": 0,
                "scenario_table_total_bytes": 0,
                "manifest_pressure": {"scenario_table_manifest_pressure": "blocked_no_scenario_table"},
            },
    ...
    def test_current_footprint_overlap_blocks_the_balfrin_handoff(self) -> None:
        ...
        self.assertEqual(auth["status"], "blocked_source_zone_footprint_overlap")
        ...
        self.assertIn("handoff_classification: `blocked_source_zone_footprint_overlap`", text)
        self.assertIn("scenario_row_count: `0`", text)
