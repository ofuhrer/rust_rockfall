...
class BalfrinSmallestMultiZoneAuthorizationPreflightTests(unittest.TestCase):
    ...
    def test_ready_package_reports_smallest_run_shape_without_granting_authorization(self) -> None:
        ...
        self.assertEqual(report["handoff_status"], "ready_for_live_postproc_submission")
        self.assertTrue(report["ready_for_live_postproc_submission"])
        ...
        self.assertEqual(report["gate_results"]["submit_contract"]["status"], "ready")
        self.assertEqual(report["gate_results"]["writable_run_root"]["status"], "ready")
        self.assertEqual(report["gate_results"]["reduced_output_profile"]["status"], "ready")
        self.assertEqual(report["gate_results"]["output_budget"]["status"], "ready")
        self.assertEqual(report["gate_results"]["preservation_plan"]["status"], "ready")
        self.assertEqual(report["gate_results"]["authorization_record"]["status"], "ready")
    ...
    def test_missing_authorization_record_blocks_closed(self) -> None:
        ...
        self.assertEqual(report["handoff_status"], "failed_closed")
        self.assertEqual(report["first_blocker"]["gate"], "authorization_record")
