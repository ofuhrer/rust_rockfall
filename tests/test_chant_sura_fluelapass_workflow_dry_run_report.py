...
class ChantSuraFluelapassWorkflowDryRunReportTests(unittest.TestCase):
    ...
    def test_missing_fixture_inputs_fail_closed_as_blocked_missing_inputs(self) -> None:
        ...
        self.assertEqual(report["real_input_acquisition_handoff"]["first_missing_real_input_category"], "terrain_metadata")
        self.assertIn("terrain_metadata", report["real_input_acquisition_handoff"]["stop_condition"])
