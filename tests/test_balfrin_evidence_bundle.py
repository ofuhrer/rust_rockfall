...
class BalfrinEvidenceBundleTests(unittest.TestCase):
    ...
    def test_current_report_is_measured_and_tracks_section_provenance(self) -> None:
        ...
        self.assertEqual(latest_gate["run_id"], "tb557_bounded_reduced_output_probe_v1")
        ...
        self.assertEqual(latest_gate["output_check"]["evidence_status"], "bounded_reduced_output")
    ...
    def test_current_multi_zone_evidence_records_tb557_measured_branch(self) -> None:
        report = bundle.build_current_report()
