...
class BoundedValidationOutputProfileTests(unittest.TestCase):
    def test_summary_records_measured_pressure_and_bounded_profile(self) -> None:
        ...
        self.assertEqual(summary["validation_output_inventory"]["validation_output_mode"], "rebuildable_reduced_output")
        self.assertIsNone(summary["validation_output_inventory"]["comparison_validation_output_mode"])
        self.assertIn("trajectory_csv", summary["validation_output_inventory"]["replay_critical_output_classes"])
        self.assertIn("trajectory_metadata_csv", summary["validation_output_inventory"]["replay_critical_output_classes"])
        self.assertIn("ensemble_impact_events_dir", summary["validation_output_inventory"]["debug_output_classes"])
    ...
    def test_validation_output_comparison_reports_before_after_accounting(self) -> None:
        ...
        self.assertFalse(summary["defaults_changed"])
        self.assertFalse(summary["scale_up_authorized"])
        self.assertFalse(summary["validation_output_inventory"]["replay_critical_family_budgets"]["trajectory_csv"]["present_in_reduced_manifest"])
        self.assertTrue(summary["validation_output_inventory"]["replay_critical_family_budgets"]["trajectory_metadata_csv"]["present_in_reduced_manifest"])
        self.assertTrue(summary["validation_output_inventory"]["debug_family_budgets"]["ensemble_impact_events_dir"]["suppressed_in_reduced_manifest"])
