...
class BalfrinDemonstrationClosurePackageTests(unittest.TestCase):
    ...
    def test_current_report_closes_target_area_metrics_branch(self) -> None:
        ...
        self.assertEqual(report["multi_zone_balfrin_evidence_section"]["status"], "failed_closed")
        self.assertEqual(report["multi_zone_balfrin_evidence_section"]["first_bottleneck_label"], "blocked_output_profile")
