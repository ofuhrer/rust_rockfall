...
def build_multi_zone_pressure_report(
    *,
    ...
    return {
        ...
        "reducer_manifest_bytes": report.get("reducer_manifest_bytes", 0),
        "reducer_manifest_file_count": report.get("reducer_manifest_file_count", 0),
        "sidecar_file_count": report.get("sidecar_file_count", 0),
        "sidecar_byte_count": report.get("sidecar_byte_count", 0),
        "primary_output_file_count": report.get("primary_output_file_count", 0),
        "primary_output_byte_count": report.get("primary_output_byte_count", 0),
        "output_family_mix": list(report.get("output_family_mix") or []),
    ...
    return {
        ...
        "profiles": {
            ...
            NEXT_REVIEW_BUDGET_PROFILE_ID: {
                ...
                "scenario_count": 4,
                "max_manifest_size_bytes": 22_000,
