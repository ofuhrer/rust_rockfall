...
def summarize_output_profile_status(output_profile: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "same_scale_rebuild_evidence": output_profile.get("same_scale_rebuild_evidence", {}),
        "summary_only_blocker_narrowing": output_profile.get("summary_only_blocker_narrowing", {}),
    ...
    return [
        {
            ...
            "local_rebuild_proof_status": (output_profile_status.get("same_scale_rebuild_evidence") or {}).get(
                "proof_status",
                "not_run",
            ),
        },
