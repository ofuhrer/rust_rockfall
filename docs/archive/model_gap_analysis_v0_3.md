...
This document compares the current independent `v0.3.0` model with the public theory available in the public RAMMS manual, Leine et al. 2014, Leine et al. 2021, and Lu et al. 2019. It does not claim parity and does not define proprietary implementation details.
