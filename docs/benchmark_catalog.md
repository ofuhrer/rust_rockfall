...
- `docs/archive/model_benchmark_execution_report.md`: consolidated expert-review
...
- `docs/archive/model_overall_assessment_report.md`: maturity and gap assessment for the
  ...
  operational work.
- `docs/archive/expert_review_briefing.md`: short reviewer briefing for rockfall,
...
Real-world validation remains partial and qualitative for v0.6.1 because the simulator lacks dynamic block-shape effects, advanced contact, calibrated scarring with drag torque/slip-dependent friction, roughness calibration, forest interaction, fragmentation, and production field DEM workflows.
