...
- `terrain_material_interaction_protocol.md`: additive implementation record for final-stop and last-significant-impact terrain/material class provenance in `stop_state`, ensemble sidecars, manifests, and summaries.
