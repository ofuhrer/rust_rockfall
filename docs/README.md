...
- `terrain_material_interaction_protocol.md`: additive implementation record for final-stop, last-significant-impact, and significant-impact sequence terrain/material class provenance in `stop_state`, ensemble sidecars, manifests, and summaries.
