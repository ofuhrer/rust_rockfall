...
<head>
  ...
  <title>Rockfall v0.6.1 Verification and Validation Report</title>
  <style>
    :root {{
      --bg: #f8fafc;
      --panel: #ffffff;
...
<body>
<main>
  <h1>Rockfall v0.6.1 Verification and Validation Report</h1>
  ...
  <div class="intro-grid">
    ...
    <section class="intro-card">
      <h2>Known Limitations Of v0.6.1</h2>
      <ul>
