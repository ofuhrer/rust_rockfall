...
pub use shape::{
    ...
    ShapeContactV0ImpulseDiagnostic, ShapeContactV0ImpulseInput, ShapeContactV0ImpulseResult,
    ShapeContactV0ImpulseSettings, ShapeContactV0PreparedImpulse, ShapeContactV0Scaffold,
